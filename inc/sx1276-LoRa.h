...
{
    RFLR_STATE_IDLE,
    RFLR_STATE_RX_INIT,  //  rx init
    RFLR_STATE_RX_RUNNING, //rx running
    RFLR_STATE_RX_DONE,  // rx done
    RFLR_STATE_RX_TIMEOUT, // rx timeout
    RFLR_STATE_TX_INIT, // tx init
    RFLR_STATE_TX_RUNNING, // tx running
    RFLR_STATE_TX_DONE, //tx done
    RFLR_STATE_TX_TIMEOUT, //tx timeout
    RFLR_STATE_CAD_INIT, //cad init
    RFLR_STATE_CAD_RUNNING, //cad running
}tRFLRStates;
...
#define AM_SX1276_LORA_REG_INVERTIQ                         0x33
#define AM_SX1276_LORA_REG_TEST36                           0x36
#define AM_SX1276_LORA_REG_DETECTIONTHRESHOLD               0x37
#define AM_SX1276_LORA_REG_SYNCWORD                         0x39
#define AM_SX1276_LORA_REG_TEST3A                           0x3A
#define AM_SX1276_LORA_REG_INVERTIQ2                        0x3B

/**
 * RegInvertIQ
 */
#define AM_SX1276_LORA_RF_INVERTIQ_RX_MASK                  0xBF
#define AM_SX1276_LORA_RF_INVERTIQ_RX_OFF                   0x00
#define AM_SX1276_LORA_RF_INVERTIQ_RX_ON                    0x40
#define AM_SX1276_LORA_RF_INVERTIQ_TX_MASK                  0xFE
#define AM_SX1276_LORA_RF_INVERTIQ_TX_OFF                   0x01
#define AM_SX1276_LORA_RF_INVERTIQ_TX_ON                    0x00

/**
 * RegInvertIQ2
 */
#define AM_SX1276_LORA_RF_INVERTIQ2_ON                      0x19
#define AM_SX1276_LORA_RF_INVERTIQ2_OFF                     0x1D
